...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    dokter.id_poli = poli.id WHERE id_poli = '$idPoli' AND hari = '$hari' AND status_jadwal = '$statusJadwal' AND ((jam_mulai < '$jamSelesai' AND jam_selesai > '$jamMulai') 
    ...
    if (mysqli_num_rows($resultOverlap)>0) {
        ...
        $query = "INSERT INTO jadwal_periksa (id_dokter, hari, jam_mulai, jam_selesai, status_jadwal) VALUES ('$idDokter', '$hari', '$jamMulai', '$jamSelesai', '$statusJadwal')";
